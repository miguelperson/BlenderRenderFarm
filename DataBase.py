...
("
    ...
    frames_total    smallint UNSIGNED, 
    start_frame     smallint UNSIGNED, 
    end_frame       smallint UNSIGNED, 
    completed       ENUM('1', '2', '3'),
...
("
    ...
    FOREIGN KEY (current_project) REFERENCES 
    )
")
#TINYINT(1) = true
...
("
    CREATE TABLE render 
    (
        frame_number    smallint UNSIGNED, 
        projectID       INT, 
...
("
    ...
    (
        ...
        worker1_avg_time VARCHAR(100), 
        worker2_avg_time VARCHAR(100), 

        FOREIGN KEY (projectID) REFERENCES project(projectID), 
        FOREIGN KEY (project_name) REFERENCES project(project_name), 
        FOREIGN KEY (worker_IP) REFERENCES workers(workerIP), 
        FOREIGN KEY (frames_total) REFERENCES project(frames_total)
    )
");         
